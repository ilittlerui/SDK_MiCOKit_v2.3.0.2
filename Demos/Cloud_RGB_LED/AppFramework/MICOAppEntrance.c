...
int application_start(void)
{
    ...
    /* user params restore check 检测用户参数*/
    ...
    /* mico system initialize  mico 系统初始化*/
...
//#endif
    ...
    /* Bonjour for service searching  服务发现 bonjour*/
    MICOStartBonjourService( Station, app_context );

    /* check wifi link status  检测wifi状态*/
    do
    {
    ...
    /* start cloud service 	启动 cloud 服务*/
